...
const ProductsPage = () => {
  ...
  return (
    <>
       <div className='heading text-[#124076] flex flex-col justify-center items-center'>
            ...
            <div className='mainRow flex gap-5 flex-wrap justify-center'>
                {
                    productData.map((item,i)=>(
                        <div key={i} className='singleCard w-[250px] h-[590px] bg-[#FFFED3] p-5 rounded-lg hover:scale-110 shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]'>
